...
```bash
axelliot-picoctf@webshell:~$ ssh ctf-player@venus.picoctf.net -p 50482
...
Warning: Permanently added '[venus.picoctf.net]:50482' (ED25519) to the list of known hosts.
...
total 32
drwxr-xr-x 1 ctf-player ctf-player 4096 Mar 14 02:06 .
drwxr-xr-x 1 root       root       4096 Mar 16  2021 ..
drwx------ 2 ctf-player ctf-player 4096 Mar 14 02:06 .cache
